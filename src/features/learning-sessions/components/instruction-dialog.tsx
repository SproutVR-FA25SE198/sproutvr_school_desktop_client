      ...
      <DialogContent className="sm:max-w-2xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="mt-6 p-4 bg-amber-50 border border-amber-200 rounded-lg">
          <p className="text-sm text-amber-800">
            <span className="font-semibold">Lưu ý:</span> Luôn kiểm tra kết nối internet và pin thiết bị trước khi bắt đầu phiên học. 
            Hãy liên hệ IT support nếu gặp vấn đề kỹ thuật.
          </p>
        </div>
      </DialogContent>
    </Dialog>
