        ...
        <div className='max-w-4xl mx-auto px-8 pt-8 pb-24 space-y-8'>
          ...
          <div>
            ...
            <div className='flex items-start justify-between'>
              <div>
                <h1 className='text-3xl font-bold text-neutral-900 mb-2  mr-2'>{map.name}</h1>
            ...
            <div className='p-8 grid grid-cols-1 md:grid-cols-3 gap-8'>
              ...
              <div className='md:col-span-1 space-y-6'>
                <div className='w-full rounded-lg overflow-hidden border border-neutral-200 bg-neutral-100'>
                  <img src={map.imageUrl} className='w-full h-auto' />
                </div>
                <div className='w-full rounded-lg overflow-hidden border border-neutral-200 bg-neutral-100'>
                  <img src={map.previewUrl} className='w-full h-auto' />
                </div>
              </div>
              ...
              <div className='md:col-span-2 space-y-4'>
                <div>
                  <label className='text-xs font-semibold text-neutral-500 uppercase tracking-wider'>Mã</label>
