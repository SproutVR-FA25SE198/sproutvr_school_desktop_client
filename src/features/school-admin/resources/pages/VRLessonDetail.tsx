        ...
        <div className='max-w-4xl mx-auto px-8 pt-8 pb-24 space-y-8'>
          ...
          <div>
            ...
            <div className='flex items-start justify-between'>
              <div>
                <h1 className='text-3xl font-bold text-neutral-900 mb-2 mr-2'>{vrLesson.name}</h1>
          ...
          <Card className='overflow-hidden'>
            ...
            <div className='p-8 space-y-4'>
              <div>
                <label className='text-xs font-semibold text-neutral-500 uppercase tracking-wider'>Tên</label>
              ...
              {vrLesson.duration && (
                <div>
                  <label className='text-xs font-semibold text-neutral-500 uppercase tracking-wider'>Thời lượng</label>
                  <div className='bg-neutral-50 rounded-lg px-4 py-3 border border-neutral-200 mt-2'>
                    <p className='text-sm text-neutral-900 whitespace-pre-wrap'>
                      {HHMMSSToDuration(vrLesson.duration).minutes} phút
                      {HHMMSSToDuration(vrLesson.duration).seconds === 0
                        ? ''
                        : ` ${HHMMSSToDuration(vrLesson.duration).seconds} giây`}
                    </p>
                  </div>
                </div>
              )}
              ...
              <div>
                <label className='text-xs font-semibold text-neutral-500 uppercase tracking-wider'>Bài giảng</label>
                <div className='bg-neutral-50 rounded-lg px-4 py-3 border border-neutral-200 mt-2'>
              ...
              <div>
                <label className='text-xs font-semibold text-neutral-500 uppercase tracking-wider'>Học liệu VR</label>
                <div className='bg-neutral-50 rounded-lg px-4 py-3 border border-neutral-200 mt-2'>
