        ...
        <div className="max-w-4xl mx-auto px-8 pt-8 pb-24 space-y-8">
          ...
          <div>
            ...
            <div className="flex items-start justify-between">
              <div>
                <h1 className="text-3xl font-bold text-neutral-900 mb-2 ml-2 mr-2">{lesson.name}</h1>
          ...
          <Card className="overflow-hidden">
            ...
            <div className="p-8 space-y-4">
                ...
                <div>
                  ...
                  <div className="bg-neutral-50 rounded-lg px-4 py-3 border border-neutral-200 mt-2">
                    <p className="text-sm text-neutral-900 whitespace-pre-wrap">{lesson.teacher.firstName} {lesson.teacher.lastName}</p>
                  </div>
                </div>
          ...
          <Card className="overflow-hidden">
            ...
            <div className="p-8 space-y-4">
                ...
                <div className="border rounded-lg overflow-hidden h-[600px]">
                    <iframe
                      src={schoolResourceUrl + lesson.resourceRelativeFilePath}
