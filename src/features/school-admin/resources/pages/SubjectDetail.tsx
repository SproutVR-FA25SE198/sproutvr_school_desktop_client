                    ...
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-2 h-2 rounded-full ${
                          m.status.key === 1 ? "bg-green-500" : "bg-neutral-400"
                        }`}
                      />
                      <p className="text-sm font-semibold text-neutral-900">{m.name}</p>
                    </div>
                    <Badge
                      variant={ m.status.key === 1 ? "secondary" : "default" }
                    >
                ...
                lessons.map((l) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-2 h-2 rounded-full ${
                          l.status.key === 1 ? "bg-green-500" : "bg-neutral-400"
                        }`}
                      />
                      <p className="text-sm font-semibold text-neutral-900">{l.name}</p>
                    </div>
                    <Badge
                      variant={ l.status.key === 1 ? "secondary" : "default" }
                    >
