    ...
    return (
        <>
            ...
            <button
                ...
                className={`fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-emerald-600 text-white shadow-lg transition-transform hover:scale-110 hover:bg-emerald-700 focus:outline-none focus:ring-4 focus:ring-emerald-300 ${isOpen ? "scale-0 opacity-0" : "scale-100 opacity-100"
                    }`}
            >
            ...
            <div
                ref={sidebarRef}
                className={`fixed bottom-0 right-0 top-0 z-50 bg-white shadow-2xl transition-transform duration-300 ease-in-out ${isOpen ? "translate-x-0" : "translate-x-full"
                    }`}
            ...
            >
                    ...
                    {messages.map((msg) => (
                        ...
                        >
                            ...
                            >
                                {/* Avatar Icon */}
                                <div
                                    className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-full border shadow-sm ${msg.role === "user"
                                ...
                                {/* Message Bubble */}
                                <div
                                    className={`relative rounded-2xl px-4 py-2.5 text-sm shadow-sm ${msg.role === "user"
                ...
                <div className="absolute bottom-0 left-0 right-0 border-t border-gray-100 bg-white p-4">
                    ...
                    <div className="mt-2 text-center text-[10px] text-gray-400">
                        Powered by Google Dialogflow & SproutVR
                    </div>
                </div>
